  ...
  return (
    ...
    <div style={styles.container}>
      ...
      <div style={styles.buttonContainer}>
        <button onClick={() => handleNavigation('/professor/exams/add')} style={styles.button}>
          Add Exams
        </button>
        <button onClick={() => handleNavigation('/professor/exams/delete')} style={styles.button}>
          Delete Exams
        </button>
        <button onClick={() => handleNavigation('/professor/exams/view')} style={styles.button}>
          View Exams
        </button>
        <button onClick={() => handleNavigation('/professor/exams/edit')} style={styles.button}>
          Edit Exams
        </button>
      </div>
    </div>
